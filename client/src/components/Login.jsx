...
function Login({ setUser }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('https://edbook-system.onrender.com/api/auth/login', {
        method: 'POST',
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch('https://edbook-system.onrender.com/api/auth/forgot-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
